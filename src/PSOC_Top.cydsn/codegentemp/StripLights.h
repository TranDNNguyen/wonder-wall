...
void   StripLights_SetCriticalFuncs(funcPtr EnCriticalFunc, funcPtr ExCriticalFunc);
void   StripLights_TriggerWait(uint32 rst);
void   StripLights_TriggerWaitDelay(uint32 delay);
...
uint32 StripLights_getColor( uint32 color);
void   StripLights_Bplot8( int32 x, int32 y, uint8 * bitMap, int32 update);
void   StripLights_Bplot32( int32 x, int32 y, uint32 * bitMap, int32 update);
uint32 StripLights_RgbBlend(uint32 fromColor, uint32 toColor, uint32 pct);
...
#define StripLights_READY_TIMEOUT 200  // 200 milliseconds (6000 LEDs)
...
#define StripLights_GAMMA_CORRECTION   0
#define StripLights_GAMMA_ON            1
#define StripLights_GAMMA_OFF           0

#define StripLights_COORD_WRAP        0
#define StripLights_COORD_NONE        (0u)
#define StripLights_COORD_XAXIS       (1u)
#define StripLights_COORD_YAXIS       (2u)
#define StripLights_COORD_XYAXIS      (3u)

#define StripLights_LED_LAYOUT       0
#define StripLights_LED_LAYOUT_STANDARD  (0u)
#define StripLights_LED_LAYOUT_SPIRAL    (1u)
#define StripLights_LED_LAYOUT_GRID16X16 (2u)

#define StripLights_FLIP_X_COORD      0
#define StripLights_FLIP_Y_COORD      0

#define StripLights_FLIP_COORD         (1u)
#define StripLights_NOT_FLIP_COORD      (0u)

#define StripLights_SWAP_XY_COORD      0
#define StripLights_XY_SWAPED          (1u)
...
#define StripLights_GRIDMODE_WRAP    0
    ...
    #define StripLights_COLUMNS      10  
    #define StripLights_ROWS         ((550 +  (10 - 1 ))/(10 ) )
    #define StripLights_TOTAL_LEDS   550

    #define StripLights_ARRAY_COLS   (int32)(550 + 10)
...
#elif (StripLights_LED_LAYOUT == StripLights_LED_LAYOUT_GRID16X16)

    #define StripLights_COLUMNS      (int32)((1) * (uint32)(16u) )
    #define StripLights_ROWS         (int32)((1) * (uint32)(16u) )
    #define StripLights_TOTAL_LEDS   (StripLights_COLUMNS*StripLights_ROWS)

    #define StripLights_ARRAY_COLS   (int32)(1*(int32)256)
    #define StripLights_ARRAY_ROWS   (int32)(1)
    
    #define StripLights_MIN_X        (int32)0
    #define StripLights_MAX_X        (int32)((1*(int32)16) - (int32)1)
    #define StripLights_MIN_Y        (int32)0
    #define StripLights_MAX_Y        (int32)((1*(int32)16) - (int32)1)
...
#define StripLights_CHIP_SF2812RGBW 3

#define StripLights_TIME_TL_TH    1250U  // 1250 us period
#if((StripLights_CHIP == StripLights_CHIP_WS2812) || (StripLights_CHIP == StripLights_CHIP_WS2811))
    #define StripLights_TIME_T0H  300U     // Logic 0 high, 300 us 
    #define StripLights_TIME_T1H  700U     // Logic 1 low, 700 us
#else
    #define StripLights_TIME_T0H  300U     // Logic 0 high, 300 us 
    #define StripLights_TIME_T1H  650U     // Logic 1 low, 700 us
#endif
 

#if (CY_PSOC3 || CY_PSOC5LP)
    #define  StripLights_INPUT_CLOCK    BCLK__BUS_CLK__KHZ
    #define  StripLights_WS281X_CLOCK   800
    #define  StripLights_PERIOD         ((StripLights_INPUT_CLOCK)/800)
#elif (CY_PSOC4)

    #define  StripLights_INPUT_CLOCK    ( CYDEV_BCLK__HFCLK__KHZ/2 )
    #define  StripLights_PERIOD         ((StripLights_INPUT_CLOCK)/800)
    #define  StripLights_DATA_ZERO      ((StripLights_PERIOD * StripLights_TIME_T0H)/StripLights_TIME_TL_TH) 
    #define  StripLights_DATA_ONE       ((StripLights_PERIOD * StripLights_TIME_T1H)/StripLights_TIME_TL_TH)
    
    #define  StripLights_COMPARE_ZERO   (StripLights_PERIOD - StripLights_DATA_ZERO)
    #define  StripLights_COMPARE_ONE    (StripLights_PERIOD - StripLights_DATA_ONE)
#endif /* CY_PSOC5A */
...
#define StripLights_RGB_WHITE   StripLights_getColor((63 + StripLights_CWHEEL_SIZE)) 
...
#define StripLights_FIRE_DARK   StripLights_getColor((74 + StripLights_CWHEEL_SIZE))
#define StripLights_FIRE_LIGHT  StripLights_getColor((75 + StripLights_CWHEEL_SIZE))

#define StripLights_FULL_WHITE  StripLights_getColor((76 + StripLights_CWHEEL_SIZE))
#define StripLights_WHITE_LED   StripLights_getColor((77 + StripLights_CWHEEL_SIZE))
#define StripLights_WHITE_RGB50 StripLights_getColor((78 + StripLights_CWHEEL_SIZE))
#define StripLights_WHITE_RGB25 StripLights_getColor((79 + StripLights_CWHEEL_SIZE))

#define StripLights_CLUT_SIZE  (96 + StripLights_CWHEEL_SIZE)

#if(StripLights_CHIP == StripLights_CHIP_SF2812RGBW)
    #define StripLights_WHITE   StripLights_getColor((77 + StripLights_CWHEEL_SIZE))   
#else
